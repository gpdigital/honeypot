  ...
  function summary1(){
    ...
    $.ajax({
        ...
        success: function(mesg) {
          ...
          //<div class="panel panel-default"><div class="panel-heading">Panel heading without title</div><div class="panel-body"><div class="row"><div class="col-md-6"><div id="donut-example" style="height: 250px;"></div></div></div></div></div>
          //setTimeout(changeMain(dum),5000);

          $("#main_section").html(dum);
          var resp = JSON.parse(mesg);
          //alert(resp[0][0]);
          //document.getElementById('container').innerHTML = JSON.stringify(mesg);
            ...
            $.getScript('http://cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.0/morris.min.js',function(){
                  ...
                  Morris.Donut({
                    ...
                    data: [
                     {label: resp[0][0], value: resp[0][1]},
                     {label: resp[1][0], value: resp[1][1]},
                     {label: resp[2][0], value: resp[2][1]},
                     {label: resp[3][0], value: resp[3][1]},
                     {label: resp[4][0], value: resp[4][1]},
                     {label: resp[5][0], value: resp[5][1]},
                     {label: resp[6][0], value: resp[6][1]},
                     {label: resp[7][0], value: resp[7][1]},
                     {label: resp[8][0], value: resp[8][1]},
                     {label: resp[9][0], value: resp[9][1]}
                    ]
                  });
                  ...
                  Morris.Bar({
                     element: 'bar-example',
                     data: [
                        {y: resp[0][0], a: resp[0][3], b: resp[0][4]},
                        {y: resp[1][0], a: resp[1][3], b: resp[1][4]},
                        {y: resp[2][0], a: resp[2][3], b: resp[2][4]},
                        {y: resp[3][0], a: resp[3][3], b: resp[3][4]},
                        {y: resp[4][0], a: resp[4][3], b: resp[4][4]},
                        {y: resp[5][0], a: resp[5][3], b: resp[5][4]},
                        {y: resp[6][0], a: resp[6][3], b: resp[6][4]},
                        {y: resp[7][0], a: resp[7][3], b: resp[7][4]},
                        {y: resp[8][0], a: resp[8][3], b: resp[8][4]},
                        {y: resp[9][0], a: resp[9][3], b: resp[9][4]}
                     ],
                     xkey: 'y',
                     ykeys: ['a', 'b'],
                     labels: ['Male', 'Female']
